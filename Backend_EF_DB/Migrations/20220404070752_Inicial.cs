    ...
    public partial class Inicial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Productos",
                columns: new[] { "ProductoId", "Descripcion", "Nombre", "Precio" },
                values: new object[] { 2, "El tecnico retira la bateria vieja y la cambia por una nueva", "Cambio de Pantalla", 800 });

            migrationBuilder.InsertData(
                table: "Productos",
                columns: new[] { "ProductoId", "Descripcion", "Nombre", "Precio" },
                values: new object[] { 3, "El tecnico retira la bateria vieja y la cambia por una nueva", "Cambio de Tarjeta Madre", 1200 });

            migrationBuilder.InsertData(
                table: "Productos",
                columns: new[] { "ProductoId", "Descripcion", "Nombre", "Precio" },
                values: new object[] { 4, "El tecnico retira la bateria vieja y la cambia por una nueva", "Cambio de Pin de Carga", 1600 });
